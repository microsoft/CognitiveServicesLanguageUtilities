...
namespace CliTool.Configs.Consts
{
    class Constants
    {
        ...
        public static readonly string ConfigsFileLocalDirectory = @"C:\Users\a-noyass\Desktop\LUIS\Cognitive-Custom_text_Utilities\CLI Tool\MS-Read Core\CliTool";
        ...
        public const string ToolName = "app";
    }
